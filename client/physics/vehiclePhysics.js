...
const STEERING_RESPONSE_MULTIPLIER = 1.18;
...
export const VEHICLE_PHYSICS_CONFIGS = {
  gt3: {
    ...
    maxSteerAngle: 0.52,
    steeringResponse: 2.15,
    steeringReturnResponse: 3.75,
    steerFadeStart: 5.5,
    steerFadeEnd: 34,
    minSteerScale: 0.36,
  ...
  amg: {
    ...
    maxSteerAngle: 0.5,
    steeringResponse: 2.05,
    steeringReturnResponse: 3.65,
    steerFadeStart: 5.5,
    steerFadeEnd: 34,
    minSteerScale: 0.36,
  ...
  ae86: {
    ...
    rearBrakeCorneringTorqueScale: 0.08,
    rearBrakeStabilityScale: 0.76,
    brakeLateralReserve: 0.98,
    rearBrakeLateralReserve: 1,
    slideLateralDamping: 0.72,
    slideYawDamping: 1.06,
    brakeSlideStability: 0.92,
    footBrakeSlideStability: 1.78,
    brakeDrift: true,
    footBrakeDriftScale: 0.05,
    brakeDriftRearBrakeScale: 0.34,
    brakeDriftRearLateralScale: 0.97,
    brakeDriftYawAssist: 0.01,
    ...
    maxSteerAngle: 0.6,
    steeringResponse: 2.85,
    steeringReturnResponse: 4.65,
    steerFadeStart: 3.5,
    steerFadeEnd: 25,
    minSteerScale: 0.28,
  ...
  rx7fd: {
    ...
    rearBrakeLateralReserve: 1,
    slideLateralDamping: 0.74,
    slideYawDamping: 1.08,
    brakeSlideStability: 0.94,
    footBrakeSlideStability: 1.8,
    brakeDrift: true,
    footBrakeDriftScale: 0.05,
    brakeDriftRearBrakeScale: 0.35,
    brakeDriftRearLateralScale: 0.97,
    brakeDriftYawAssist: 0.01,
    handbrakeTorqueScale: 0.5,
    driftRecoveryRate: 2.7,
    handbrakeRearGripScale: 0.31,
    handbrakeFrontGripScale: 0.94,
    handbrakeYawAssist: 1.16,
    handbrakeYawDamping: 0.62,
    handbrakeSpinDamping: 3.0,
    highSpeedGripLossStart: 152 / 3.6,
    highSpeedGripLossEnd: 218 / 3.6,
    highSpeedGripScale: 0.72,
    ...
    maxSteerAngle: 0.53,
    steeringResponse: 2.35,
    steeringReturnResponse: 4.05,
    steerFadeStart: 6.0,
    steerFadeEnd: 38,
    minSteerScale: 0.39,
    rollingResistance: 0.016,
    airDrag: 0.4,
    downforce: 0.88,
    downforceLoadCap: 0.64,
    frontDownforceShare: 0.44,
    aeroGripEfficiency: 0.68,
    drivetrainType: DRIVETRAIN_TYPES.RWD,
    drivetrainEfficiency: 0.88,
    idleRpm: 1000,
    maxRpm: 8800,
  ...
  rx7fc: {
    ...
    handbrakeFrontGripScale: 0.94,
    handbrakeYawAssist: 1.14,
    handbrakeYawDamping: 0.6,
    handbrakeSpinDamping: 2.9,
    ...
    airDrag: 0.5,
    downforce: 0.68,
    downforceLoadCap: 0.54,
    frontDownforceShare: 0.43,
    aeroGripEfficiency: 0.64,
    drivetrainType: DRIVETRAIN_TYPES.RWD,
    drivetrainEfficiency: 0.87,
    idleRpm: 950,
    maxRpm: 8200,
  ...
  formulaRb22: {
    mass: 805,
    centerOfMassHeight: 0.24,
    wheelBase: 3.42,
    trackWidth: 1.98,
    tireRadius: 0.45,
    visualFrontTireRadius: 0.43,
    visualRearTireRadius: 0.48,
    visualFrontTireWidth: 0.42,
    visualRearTireWidth: 0.54,
    wheelInertia: 1.08,
    wheelConnectionY: -0.22,
    chassisHalfExtents: { x: 1.16, y: 0.28, z: 2.55 },
    suspensionRestLength: 0.22,
    suspensionTravel: 0.105,
    springStiffness: 178000,
    damperStiffness: 16800,
    bumpStopStiffness: 360000,
    antiRollStiffness: 76000,
    tireGrip: 1.88,
    frontTireGripScale: 1.04,
    rearTireGripScale: 0.98,
    lateralGrip: 1.34,
    longitudinalGrip: 1.18,
    engineForce: 26800,
    brakeForce: 42000,
    brakeBias: 0.58,
    brakeResponse: 8.4,
    brakeReleaseResponse: 13.2,
    brakeCorneringTorqueScale: 0.52,
    rearBrakeCorneringTorqueScale: 0.34,
    rearBrakeStabilityScale: 0.42,
    brakeLateralReserve: 0.98,
    rearBrakeLateralReserve: 0.86,
    slideLateralDamping: 1.08,
    slideYawDamping: 1.46,
    brakeSlideStability: 0.62,
    handbrakeRearGripScale: 0.48,
    handbrakeFrontGripScale: 0.96,
    handbrakeTorqueScale: 0.34,
    handbrakeYawAssist: 0.72,
    handbrakeYawDamping: 1.12,
    handbrakeSpinDamping: 4.4,
    accelerationResponse: 24,
    longitudinalForceResponse: 38,
    driveInputRamp: 9.4,
    driveInputReleaseRamp: 12.5,
    slipRatioDeadband: 0.012,
    maxSteerAngle: 0.52,
    steeringResponse: 2.55,
    steeringReturnResponse: 4.4,
    steerFadeStart: 9.5,
    steerFadeEnd: 74,
    minSteerScale: 0.22,
    ...
    airDrag: 0.64,
    downforce: 8.4,
    downforceLoadCap: 3.25,
    frontDownforceShare: 0.48,
    aeroGripEfficiency: 0.98,
    drivetrainType: DRIVETRAIN_TYPES.RWD,
    ...
    upshiftRpm: 14200,
    downshiftRpm: 6800,
    gearRatios: [-2.9, 0, 3.1, 2.32, 1.88, 1.54, 1.29, 1.1, 0.96],
    finalDrive: 3.45,
    clutch: { bite: 0.92, shiftTime: 0.09 },
    engineTorqueCurve: [
      [4200, 260],
      [6500, 420],
      [8800, 610],
    ...
    maxReverseSpeed: 45 / 3.6,
    abs: true,
    absSlip: 0.62,
    inertia: { linearDamping: 0.014, angularDamping: 0.42 },
  },
};
